<?php
    ...
    class SearchAuditLogs extends RequestHandler implements RequestSpecificationInterface
    {
        private const string ERROR_SEARCH_DISABLED = 'Search functionality is disabled for audit logs';
        ...
        private const string ERROR_AUTH_REQUIRED = 'Authentication is required to search audit logs';
        ...
        public static function handleRequest(): void
        {
            ...
            if (!$searchConfig->isEnabled() || !$searchConfig->isAuditLogsEnabled())
            {
            ...
            try
            {
                $results = AuditLogManager::searchAuditLogs($likePattern, $limit, $page, $authenticatedOperator !== null);
            }
            ...
            self::successResponse(array_map(fn(AuditLog $r) => $r->toArray(), $results));
        }
        ...
        public static function getResponses(): array
        {
            return [
                '200' => [
                    'description' => 'List of matching audit log entries',
                    'content' => [
                        'application/json' => [
                            'schema' => [
                                'type' => 'array',

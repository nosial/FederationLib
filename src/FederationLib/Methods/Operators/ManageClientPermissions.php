<?php
    ...
    class ManageClientPermissions extends RequestHandler implements RequestSpecificationInterface
    {
        ...
        {
            return 'Manage client permissions for an operator';
        }
        ...
        {
            return 'Enables or disables client permissions for an operator. Cannot modify permissions for the root operator. Requires operator management permissions.';
        }
        ...
        {
            return 'manageClientPermissions';
        }
                    ...
                    'application/json' => [
                        'schema' => [
                            ...
                            'properties' => [
                                'enabled' => [
                                    'type' => 'boolean',
                                    'description' => 'Whether client permissions should be enabled',
                                ],
                            ],
                            'required' => ['enabled'],
                        ],

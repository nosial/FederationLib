<?php
    ...
    class ListAssignedOperatorReports extends RequestHandler implements RequestSpecificationInterface
    {
        ...
        public static function handleRequest(): void
        {
            ...
            try
            {
                self::successResponse(ReportManager::getReportsByAssignedOperator($operator, $limit, $page, $category));
            }
        ...
        {
            return 'List reports assigned to an operator';
        }
        ...
        {
            return 'Retrieves a paginated list of reports assigned to a specific operator. Reports must be public or the operator must be authenticated.';
        }
        ...
        {
            return 'listAssignedOperatorReports';
        }
        ...
        public static function getResponses(): array
        {
            return [
                '200' => [
                    'description' => 'List of reports assigned to the operator',
                    'content' => [
                        'application/json' => [
                            'schema' => [
                                'type' => 'array',

<?php
    ...
    class ManageAutoAssign extends RequestHandler implements RequestSpecificationInterface
    {
        ...
        private const string ERROR_CANNOT_MODIFY_BUILTIN = 'Cannot modify auto assign for a builtin operator';
        private const string ERROR_UNABLE_TO_MANAGE = 'Unable to manage operator\'s auto assign';
        ...
        public static function handleRequest(): void
        {
            ...
            if(!preg_match('#^/operators/([a-fA-F0-9\-]{36})/auto-assign$#', FederationServer::getPath(), $matches))
            {
        ...
        {
            return 'Manage auto assign for an operator';
        }
        ...
        {
            return 'Enables or disables the ability for an operator to automatically receive assigned reports. Cannot modify auto assign for builtin operators (root/system). Requires operator management permissions.';
        }
                    ...
                    'application/json' => [
                        'schema' => [
                            ...
                            'properties' => [
                                'enabled' => [
                                    'type' => 'boolean',
                                    'description' => 'Whether auto assign should be enabled',
                                ],
                            ],
                            'required' => ['enabled'],
                        ],
        ...
        public static function getResponses(): array
        {
            return [
                '200' => [
                    'description' => 'Operator auto assign updated successfully',
                    'content' => [
                        'application/json' => [

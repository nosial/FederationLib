<?php
    ...
    class SearchOperators extends RequestHandler implements RequestSpecificationInterface
    {
        ...
        public static function handleRequest(): void
        {
            ...
            if (!$searchConfig->isEnabled() || !$searchConfig->isOperatorsEnabled())
            {
            ...
            try
            {
                $results = OperatorManager::searchOperators($likePattern, $limit, $page, !$authenticatedOperator->hasOperatorPermissions());
            }
            ...
            self::successResponse(array_map(fn(OperatorRecord $r) => $r->toArray(), $results));
        }
        ...
        public static function getResponses(): array
        {
            return [
                '200' => [
                    'description' => 'List of matching operators',
                    'content' => [
                        'application/json' => [
                            'schema' => [
                                'type' => 'array',

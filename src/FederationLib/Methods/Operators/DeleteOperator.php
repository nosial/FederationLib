<?php
    ...
    class DeleteOperator extends RequestHandler implements RequestSpecificationInterface
    {
        private const string ERROR_INSUFFICIENT_PERMISSIONS = 'Insufficient permissions to delete operators';
        ...
        private const string ERROR_CANNOT_DELETE_BUILTIN_OPERATOR = 'Cannot delete the builtin operator';
        private const string ERROR_UNABLE_TO_DELETE = 'Unable to delete operator';
        ...
        public static function handleRequest(): void
        {
            ...
            try
            {
                ...
                {
                    throw new RequestException(self::ERROR_CANNOT_DELETE_BUILTIN_OPERATOR, HttpResponseCode::FORBIDDEN);
                }

                OperatorManager::deleteOperator($operatorUuid);
                AuditLogManager::createEntry(AuditLogType::OPERATOR_DELETED, sprintf('Operator %s (%s) deleted by %s',
        ...
        {
            return 'Permanently deletes an operator. Cannot delete the root operator. Requires operator management permissions.';
        }

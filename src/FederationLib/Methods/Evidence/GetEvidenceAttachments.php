<?php
    ...
    class GetEvidenceAttachments extends RequestHandler implements RequestSpecificationInterface
    {
        ...
        public static function handleRequest(): void
        {
            ...
            if(!preg_match('#^/evidence/([a-fA-F0-9\-]{36})/attachments$#', FederationServer::getPath(), $matches))
            {
            ...
            try
            {
                ...
                $attachments = FileAttachmentManager::getRecordsByEvidence($evidenceRecord->getUuid());
            }
            ...
            self::successResponse(array_map(fn($record) => $record->toArray(), $attachments));
        }
        ...
        {
            return 'Get evidence attachments';
        }
        ...
        {
            return 'Retrieves all file attachments associated with an evidence record.';
        }
        ...
        public static function getParameters(): array
        {
            return [
                [
                    ...
                    'description' => 'UUID of the evidence record',
                ],
            ];
        }
        ...
        public static function getResponses(): array
        {
            return [
                '200' => [
                    'description' => 'List of file attachments for the evidence',
                    'content' => [
                        'application/json' => [
                            'schema' => [
                                'type' => 'array',

<?php
    ...
    class ListReports extends RequestHandler implements RequestSpecificationInterface
    {
        ...
        {
            return 'Retrieves a paginated list of all reports. Reports must be public or the operator must be authenticated.';
        }

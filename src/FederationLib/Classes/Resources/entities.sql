...
(
    ...
    metadata            varchar(8192)                              null comment 'Optional. JSON data of the entity (8kb limit)',
    ...
    updated             timestamp                                  null comment 'The Timestamp for when the entity record was last updted',
